...
public class SprintController {
    ...
    public List<SprintResponse> getByProject(@PathVariable UUID projectId) {
    ...
    public ResponseEntity<Void> cancelSprint(@PathVariable UUID sprintId) {
        sprintService.cancelSprint(sprintId);
        return ResponseEntity.noContent().build();
    }

    @GetMapping("/{sprintId}/workitems")
    ...
    @PostMapping("/{sprintId}/workitems")
    public ResponseEntity<SprintWorkItemResponse> addWorkItem(
        ...
        return ResponseEntity
                .status(HttpStatus.CREATED)
                .body(sprintService.addWorkItem(sprintId, request));
    }

    @DeleteMapping("/{sprintId}/workitems/{workItemId}")
    ...
    public SprintCapacityResponse getCapacity(@PathVariable UUID sprintId) {
        return sprintService.calculateCapacity(sprintId);
    }
}
